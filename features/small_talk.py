...
async def small_talk(activity):
    if activity.get("text") == "bye":
        ...
        responses = [
            ...
            "Seeing the funny side of life comes naturally to you\t",
            "Others see you as outgoing and full of laughter",
            "You love cracking a good joke at the perfect moment",
            "You make people laugh wherever y go",
            "Coming up with funny things to say is easy for you",
            "You can calm any situation by having a good laugh",
            "You just naturally see the funny side to life",
            "Making others laugh is easy for you",
            ...
            "The more you like yourself, the more others will like you",
            "You are becoming better with each day",
            ...
            "You are proud to represent the values that matter to you and your community",
            "You love yourself",
            "You feel lucky to have the opportunities that you do",
            ...
            "You are responsible with your technology",
            ...
            "You can say no, and no will mean no",
            "You stand up for yourself because you matter",
            ...
            "You do not regret yesterday and you are excited for tomorrow",
            "This is only the beginning",
            "You will do better next time",
            "You haven’t even seen what you are capable of yet",
            "You will savor your youth",
            "You do not wish for age but instead experiences and knowledge",
            ...
            "You love your body",
            "You're not perfect, but nobody is",
            "You love you life",
            "You deserve love",
...
async def send_msg(resps, act):
    ...
    message = dict(
        text=reply, roomId=act["roomId"], parentId=act["parentId"], attachments=[]
    )
    await webex.post_message_to_webex(message)
